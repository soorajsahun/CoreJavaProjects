...
public class PdfECertificateCreation2 {
	public static void main(String[] args)throws Exception {
		
		// Enter a valid Path with FileName
		String pdfName="E:\\PdfECertificateCreation\\pdfECertificate2.pdf";
...
//		PdfAction=Launches an application or a document->the application to be launched or the document to be opened or printed.
		...
		Image image = Image.getInstance("E:\\PdfECertificateCreation\\2.jpeg");
...
//					headerData = input.nextLine();
				setData(pdfStamper, headerData, BaseFont.TIMES_BOLDITALIC, 26, BaseColor.BLACK, 530, 520, 70,
						370);
...
//					studentName = input.nextLine();
				setData(pdfStamper, studentName, BaseFont.TIMES_BOLDITALIC, 34, BaseColor.ORANGE, 530, 416, 80, 370);
...
//					midData = input.nextLine();
				...
				setData(pdfStamper, midData, BaseFont.TIMES_BOLDITALIC, 14, BaseColor.BLACK, 530, 220, 70, 340);
...
//					nameOfHeadPerson = "Mr. "+nameOfHeadPerson;
				setData(pdfStamper, nameOfHeadPerson, BaseFont.TIMES_BOLDITALIC, 18, BaseColor.BLUE, 360, 170, 575,
						100);
